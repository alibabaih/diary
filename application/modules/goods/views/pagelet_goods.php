<section class="todo-control">
    <header>
        <?php echo form_open('goods/goods_ajax/create', 'rel="async" class="form-horizontal" autocomplete="off"'); ?>
        <div class="form-group">
            <div class="col-xs-1">
                <a rel="async" href="#" ajaxify="<?php echo site_url('goods/goods_ajax/toggle_all'); ?>">
    ...
    <section class="todo-list" data-filter="all">
        <?php foreach ($items as $item): ?>
            <?php echo Modules::run('goods/_pagelet_item', $item); ?>
        <?php endforeach; ?>
    </section><hr>
    ...
    <footer class="clearfix">
        ...
        <ul class="todo-filter list-inline pull-right">
            <li><a rel="async" href="#" ajaxify="<?php echo site_url('goods/goods_ajax/filter/all'); ?>">All</a></li>
            <li><a class="text-muted" rel="async" href="#" ajaxify="<?php echo site_url('goods/goods_ajax/filter/active'); ?>">Active</a></li>
            <li><a class="text-muted" rel="async" href="#" ajaxify="<?php echo site_url('goods/goods_ajax/filter/completed'); ?>">Completed</a></li>
        </ul>
    </footer>
</section>